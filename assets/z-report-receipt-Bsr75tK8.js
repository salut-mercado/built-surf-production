import{cm as $,bw as b,cn as h,co as f}from"./index-DOEywZSa.js";const w={en:f,es:h};function y(t){return t.toLowerCase().startsWith("es")?"es":"en"}function R(t){return w[y(t)]}function I(t){const i=R(t);return{...i.stores.view.overview.zReportReceipt,cashPayment:i.stores.pos.cash,cardPayment:i.stores.pos.creditCard}}const L=`
