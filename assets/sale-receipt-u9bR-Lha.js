import{cu as R,cL as D,cM as S,bQ as C}from"./index-Drp79zBX.js";const A=`
...
`,Q={en:S,es:D};function h(e){return e.toLowerCase().startsWith("es")?"es":"en"}function g(e){return Q[h(e)]}function a(e,t,o){return new Intl.NumberFormat(t,{style:"currency",currency:o,minimumFractionDigits:2,maximumFractionDigits:2}).format(e)}function d(e,t,o){return new Intl.NumberFormat(t,{minimumFractionDigits:o,maximumFractionDigits:o}).format(e)}function m(e,t){return d(e,t,2)}function B(e,t,o){const c=typeof e=="number"?new Date(e):e??null;return C(c,t,o)}function E(e){const t=g(e);return{taxId:t.stores.pos.receipt.taxId,phone:t.stores.pos.receipt.phone,operationDateTime:t.stores.pos.receipt.operationDateTime,receiptId:t.stores.pos.receipt.receiptId,name:t.stores.pos.receipt.name,unitPrice:t.stores.pos.receipt.unitPrice,amount:t.stores.pos.receipt.amount,total:t.stores.pos.total,change:t.stores.pos.change,taxBreakdown:t.stores.pos.receipt.taxBreakdown,base:t.stores.pos.receipt.base,quota:t.stores.pos.receipt.quota,qrPromoLine1:t.stores.pos.receipt.qrPromoLine1,qrPromoLine2:t.stores.pos.receipt.qrPromoLine2,notProvided:t.common.notProvided}}function N(e){const t=e<=1?e*100:e;return Math.abs(t-4)<.5?4:Math.abs(t-10)<.5?10:21}const M=R(A,e=>{const t=h(e.language),o=g(t),c=E(t),i=e.store.currency??"EUR",_=c.notProvided,n=new Map([[4,{base:0,quota:0,itemCount:0}],[10,{base:0,quota:0,itemCount:0}],[21,{base:0,quota:0,itemCount:0}]]),b=e.items.map(s=>{const r=s.quantity*s.price,P=s.vatRate<=1?s.vatRate:s.vatRate/100,T=N(s.vatRate),u=r/(1+P),w=r-u,p=n.get(T);p&&(p.base+=u,p.quota+=w,p.itemCount+=1);const l=!!(s.isWeighted&&s.weightKg!=null),L=l?"1":d(s.quantity,t,Number.isInteger(s.quantity)?0:3),I=l?s.unitPricePerKg??s.price:s.price;return{name:s.name,displayQuantity:L,unitPrice:s.quantity>1?m(I,t):"",lineTotal:m(r,t),isWeighted:l,weightLine:l?`${d(s.weightKg??s.quantity,t,3)} kg x ${a(s.unitPricePerKg??s.price,t,i)}/kg = ${a(r,t,i)}`:void 0}}),v=[4,10,21].flatMap(s=>{const r=n.get(s)??{base:0,quota:0,itemCount:0};return r.itemCount===0?[]:[{rate:`${s}%`,base:a(r.base,t,i),quota:a(r.quota,t,i)}]}),f=Array.from(n.values()).reduce((s,r)=>s+r.base,0),y=Array.from(n.values()).reduce((s,r)=>s+r.quota,0),x=e.method==="cash"?o.stores.pos.cash:o.stores.pos.creditCard,q=e.method==="cash"?e.cash??e.total:e.total;return{storeName:e.store.name?.trim()||"Salut",storeTaxId:e.store.taxId?.trim()||_,address:e.store.address?.trim()||_,phone:e.store.phone?.trim()||_,operationDateTime:B(e.operationDate,t,e.store.timezone),receiptNumber:e.receiptNumber,receiptBarcode:e.receiptBarcode,barcodeSvg:e.barcodeSvg,receiptQrSvg:e.receiptQrSvg,items:b,total:a(e.total,t,i),paymentLabel:x,paymentAmount:a(q,t,i),change:e.change!=null?a(e.change,t,i):void 0,showChange:e.method==="cash"&&e.change!=null&&e.change>0,taxes:v,taxBaseTotal:a(f,t,i),taxQuotaTotal:a(y,t,i),labels:c}});export{M as s};
